...
/**
 * This class contains the front-end (GUI) for <a href="http://de.wikipedia.org/wiki/2048_(Computerspiel)">2048</a> games. You can provide the following command line arguments when starting up the GUI using its integrated main method:
 * <ul>
 ...
 * <li>the second argument is the height of the game board (defaults to 4 if not provided at all or outside legal range [2,44])</li>
 * <li>the third argument is the width of the game board (defaults to the height if not provided at all or outside legal range [2,44])</li>
 * </ul>
 * 
 * @author John Doe
...
public final class AuD2048 {
	...
	private static final class AuD2048Frame extends JFrame implements ActionListener, KeyListener {
		...
		private AuD2048Frame(String[] args) {
			...
			try {
				logic = Class.forName(logicName).asSubclass(AuD2048Logic.class).getDeclaredConstructor(int.class, int.class).newInstance(rows, cols);
			} catch (Throwable t) {
